...
public class vehicularCloudConsole {
	// Creating class level user type variable to identify the current user (Owner
	// or Client)
	private String currentUserType;

	// Importing necessary frames, panels, textfields, buttons, etc.
	...
	public vehicularCloudConsole() {
		...
		loginScreenPanel.add(new JLabel());
	...
	// Method for saving information once user clicks submit button
	private void saveInformation() {
		...
		// FileWriter use to write collected data into text file with time stamps
	...
	// Clears text fields once submit button is pressed
